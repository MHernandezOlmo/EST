...
namespace Libtween.Equations
{
    // This code has been adapted from https://github.com/noisecrime/Unity-EasingLibraryVisualisation
    // LICENSE: This file is under MIT License - Credits to Noisecrime
    public static class EasingEquations
    {
        ...
        /// <summary>
        /// Easing equation function for a circular (sqrt(1-t^2f)) easing out: 
        /// decelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a circular (sqrt(1-t^2f)) easing in: 
        /// accelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a circular (sqrt(1-t^2f)) easing in/out: 
        /// acceleration until halfway, then deceleration.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quadratic (t^2f) easing out: 
        /// decelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quadratic (t^2f) easing in: 
        /// accelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quadratic (t^2f) easing in/out: 
        /// acceleration until halfway, then deceleration.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quadratic (t^2f) easing out/in: 
        /// deceleration until halfway, then acceleration.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a cubic (t^3f) easing out: 
        /// decelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a cubic (t^3f) easing in: 
        /// accelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a cubic (t^3f) easing in/out: 
        /// acceleration until halfway, then deceleration.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a cubic (t^3f) easing out/in: 
        /// deceleration until halfway, then acceleration.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quartic (t^4f) easing out: 
        /// decelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quartic (t^4f) easing in: 
        /// accelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quartic (t^4f) easing in/out: 
        /// acceleration until halfway, then deceleration.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quartic (t^4f) easing out/in: 
        /// deceleration until halfway, then acceleration.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quintic (t^5f) easing out: 
        /// decelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quintic (t^5f) easing in: 
        /// accelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a quintic (t^5f) easing in/out: 
        /// acceleration until halfway, then deceleration.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a back (overshooting cubic easing: (s+1f)*t^3f- s*t^2f) easing out: 
        /// decelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a back (overshooting cubic easing: (s+1f)*t^3f- s*t^2f) easing in: 
        /// accelerating from zero velocity.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a back (overshooting cubic easing: (s+1f)*t^3f- s*t^2f) easing in/out: 
        /// acceleration until halfway, then deceleration.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
        ...
        /// <summary>
        /// Easing equation function for a back (overshooting cubic easing: (s+1f)*t^3f- s*t^2f) easing out/in: 
        /// deceleration until halfway, then acceleration.
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Starting value.</param>
